...
namespace egn {
    inline void drawMesh(const Mesh& mesh, const gll::Mat4& model, const gll::Mat4& view, const gll::Mat4& proj,
        ...
        for (int i = 0; i < mesh.indices.size(); i += 3) {
            ...
            auto packColorOverW = [](uint32_t color, float invW) -> uint32_t {
